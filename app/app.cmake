...
if(QT_VERSION_MAJOR EQUAL 6)
    ...
    qt5_add_translation(QM_FILES ${APP_TRANSLATIONS})
endif()
...
if(APPLE)
    ...
    add_executable(pencil2d MACOSX_BUNDLE
        ${CORE_LIB_HEADERS}
        ${CORE_LIB_SOURCES}
...
elseif(WIN32)
    ...
    configure_file(
        ${CMAKE_CURRENT_SOURCE_DIR}/app/data/version.rc.in
        ${CMAKE_CURRENT_BINARY_DIR}/version.rc
        @ONLY
    )
    
    add_executable(pencil2d WIN32
        ${CORE_LIB_HEADERS}
        ${CORE_LIB_SOURCES}
        ${CORE_LIB_RESOURCES}
        ${APP_HEADERS}
...
if(APPLE)
    target_link_libraries(pencil2d PRIVATE ${PLATFORM_LIBS})
endif()
