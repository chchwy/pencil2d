...
TEST_CASE("Saving recovers after a keyframe move failed half-way")
{
    ...
    // holds the file), the keyframes renamed before it are left under their
    // temporary names. Once the file is free again, saving must work again.
    FileManager fm;
